...
export const exploreCategories: ExploreCategory[] = [
  ...
  },
  {
    ...
    recommendations: [
      ...
      {
        id: 'act-5',
        name: 'Get Your Workout In!!',
        note: 'Fitness Gym & Cardio',
        distance: 'On Estate · Gym Facility',
        quote: 'From cardio to weights, our gym is ready for you to break a sweat and feel great!',
        image: '/photos/gym/gym_01.jpeg',
      },
      {
        id: 'act-6',
        ...
        quote: 'Get comfy by the fire, toast up, and let the crackling flames set the perfect mood for a chill evening.',
        image: '/photos/patio/patio_01.jpeg',
      },
      {
        id: 'act-7',
        name: 'Find Your Cozy Corner',
        note: 'Reading Nooks & Terraces',
        distance: 'On Estate · Villa Nooks',
        quote: 'Whether it’s a quiet nook with a book or a comfy couch with a view, these cozy corners are made for relaxing!',
      ...
      },
      {
        ...
        quote: 'Breathe deep, stretch it out, and find your inner calm with a personalized yoga session. Contact for yoga instructor.',
        image: '/photos/additional_photos/yoga.jpeg',
      },
      {
        id: 'act-9',
        name: 'Hike Around the Villa',
        note: 'Estate Surroundings & Trails',
        distance: 'On Estate · Nature Trails',
        quote: 'Explore the scenic trails around the villa and enjoy the peaceful surroundings. A perfect start or end to any day!',
        image: '/photos/exterior/exterior_10.jpeg',
      },
      {
        id: 'act-10',
        name: 'Chase the Adventure - Waterfall Hike',
        note: 'Mountain Waterfall Exploration',
        distance: 'Nearby · Nature Trail',
        quote: 'Discover nature’s beauty with a hike to a nearby waterfall. It’s the perfect way to explore the outdoors.',
        image: '/photos/additional_photos/additional_photos_12.jpeg',
      },
      {
        id: 'act-11',
        name: 'Breathe Deep, Feel Good - Steam Bath',
        note: 'Eucalyptus Steam Bath',
        distance: 'On Estate · Wellness Center',
        quote: 'Step into the steam bath and let the warmth and steam melt away your stress. Instant relaxation!',
        image: '/photos/additional_photos/additional_photos_28.avif',
      },
      {
        id: 'act-12',
        name: 'Cravings? We’ve Got You - Order Food',
        note: 'WhatsApp Essentials & Local Delivery',
        distance: 'In-Villa Delivery',
        quote: 'From snacks to meals, just call and order whatever you’re craving and have it delivered right to your door.',
        image: '/photos/dining_area/dining_area_01.jpeg',
      },
      {
        id: 'act-13',
...
export const checkoutSteps = [
  { id: '1', title: 'Turn-off all the lights and electronic devices.' },
  { id: '2', title: 'Lock all windows and doors before leaving.' },
  { id: '3', title: 'Check all the power sockets and make sure none of your electronic device left.' },
  { id: '4', title: 'Put everything in their original positions.' },
  { id: '5', title: 'Make sure all of the water taps are shut.' },
  { id: '6', title: 'Make sure you dont carry any thing with you which belong to the property.' },
];
