...
export function StatsBar() {
  const stats = [
    { icon: ShieldCheck, label: '100% Exclusive', detail: '3.5 Private Mountain Acres' },
    ...
    { icon: Plane, label: '45 Min to MDE', detail: 'Private Airport SUV Transfer' },
  ];
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          {stats.map((stat, idx) => {
            ...
            return (
              <div
                key={idx}
                className="flex flex-col items-center text-center group p-3 transition-all duration-300 hover:bg-ink-700/40"
              >
                <div className="flex h-12 w-12 items-center justify-center bg-champagne-500/10 text-champagne-400 border border-champagne-500/20 group-hover:bg-champagne-500 group-hover:text-ink-900 transition-all duration-300">
